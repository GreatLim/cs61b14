...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    int N = table.size();
    int n = numBoards;
    double num  = n - N + N * Math.pow(1 - 1.0/N, n);
    System.out.println(table + "\n");
    System.out.println("the number of boards = " + n);
    System.out.println("the number of buckets = " + N);
    System.out.println("actual number of collision = " + table.numCollision());
    System.out.println("expected number of collision = " + num);
  }
}
