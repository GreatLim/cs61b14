...
class Fraction {
   ...
   *  @param new_numerator is the new numerator.  Must be nonnegative.
   */
  public void changeNumerator(int new_numerator) { // DO NOT CHANGE THIS SIGNATURE!
   ...
   */
  static private int fracs() {                         // DO NOT CHANGE THIS SIGNATURE!
    // Fix the bug that prevents this method from working correctly.
