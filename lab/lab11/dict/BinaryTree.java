...
public class BinaryTree implements Dictionary {
    ...
    public Entry remove(Object key) {
        ...
        if(n == null){
            ...
            BinaryTreeNode temp = new BinaryTreeNode(root.entry, null);
            ...
            if(n.leftChild == null && n.rightChild == null) {
                ...
                BinaryTreeNode n1 = findMin(n.rightChild);
                n.entry = n1.entry;
                if(n1 == n.rightChild) {
                    n.rightChild = null;
                    n1.parent = null;
                } else if(n1.rightChild == null) {
                    n1.parent.leftChild = null;
                    n1.parent = null;
                } else {
                    n1.rightChild.parent = n1.parent;
                    n1.parent.leftChild = n1.rightChild;
                    n1.rightChild = null;
                    n1.parent = null;
                }
            }
