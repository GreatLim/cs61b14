...
public class SplayTree implements Dictionary {
    ...
    private void splayNode(BinaryTreeNode node) {
        ...
        while (node.parent != null) {
            ...
            if (parent == root) {
                zig(node);
            } else if ((node == parent.rightChild && parent == parent.parent.leftChild) ||
                    (node == parent.leftChild && parent == parent.parent.rightChild)) {
                zigZag(node);
            }  else if ((node == parent.rightChild && parent == parent.parent.rightChild) ||
                    (node == parent.leftChild && parent == parent.parent.leftChild)) {
                zigZig(node);
            }
        }
